...
public class Klient2 implements KinomaniakInterface {
    ...
    /**
     * metoda nawiązująca połączenie z serwerem, wywołuje metode init, oraz
     * metode pobierzBaze. przechodzi do stanu gotowości do rpacy między
     * serwerem a klientem
     *
     * @return 0 - jeśli wykona się poprawnie -1 - jeśli błąd połączenie lub
     * inny błąd -2 - jeślij błąd logowania
     */
    @Override
    public int connect() {
        init();
     ...
     * @param idse - parametr pobierany z GUI - ID seansu na która ma zostać
     * dokonana rezerwacja
     * @param miejsca - tablica z miejscami jakie mają zostac zarezerwowane
     * @return 0 - jeśli się poprawnie wykona -1 - jeśli wystąpi jakikolwiek
     * błąd
     */
    @Override
     ...
     *
     * @param imienaz - paarametr pobierany z GUI, imie i nazwisko do odbioru
     * rezerwacji
